...
TextStyle menuTextStyle = TextStyle(color: Colors.black, fontSize: Util.px_15 * SizeConfig.textMultiplier,  fontWeight: FontWeight.normal,fontFamily: "Gibson");
TextStyle selectedMenuTextStyle = TextStyle(color: Colors.blue, fontSize: Util.px_16 * SizeConfig.textMultiplier,  fontWeight: FontWeight.w600, fontFamily: "Times",);
